...
class RegionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create region" do
    assert_difference('Region.count') do
      post regions_url, params: { region: { comment: @region.comment, region_desc: @region.region_desc } }
    end
  ...
  test "should update region" do
    patch region_url(@region), params: { region: { comment: @region.comment, region_desc: @region.region_desc } }
